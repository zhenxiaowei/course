 ...
 */
!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(['vue'], t) : "object" == typeof exports ? exports["vue-datepicker-local"] = t() : e["vue-datepicker-local"] = t()
    ...
    return function (e) {
        ...
        return t.m = e, t.c = s, t.d = function (e, s, n) {
            t.o(e, s) || Object.defineProperty(e, s, {configurable: !1, enumerable: !0, get: n})
        }, t.n = function (e) {
        ...
        var i = {
            name: "VueDatepickerLocalCalendar", props: {value: null, left: !1, right: !1}, data: function () {
                ...
                local: function () {
                    ...
                    var e = [], t = this, s = t.year, n = t.month, o = new Date(s, n, 1), a = t.local.dow || 7;
                    o.setDate(0);
                    ...
                    var u = 1;
                    for (u = 1; u <= r; u++) e.push({i: u, y: s, m: n});
                    for (u = 1; e.length < 42; u++) e.push({i: u, y: n < 11 ? s : s + 1, m: n < 11 ? n + 1 : 0, n: !0});
                    return e
                }
            }, filters: {
                dd: function (e) {
                ...
                get: function (e) {
                    ...
                    var i = this, c = new Date(e, t + 1, 0).getDate(), u = new Date(e, t, s > c ? c : s, n, o, a),
                        l = i.parse(u), h = i.$parent.tf, d = {}, p = !1;
                    ...
                    if (e && e.n && t.nm(), e && e.p && t.pm(), "h" === e) {
                        var o = t.get(this.value);
                        s = o.year, n = o.month
                    }
                    var a = new Date(s || t.year, n || t.month, t.day, t.hour, t.minute, t.second);
                    t.left && parseInt(a.getTime() / 1e3) > t.end && (this.$parent.dates[1] = a), t.$emit("input", a), t.$parent.ok("h" === e)
                }
            }, mounted: function () {
            ...
            return s("div", {class: "" + e.pre}, [s("div", {class: e.pre + "-head"}, [s("a", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                    value: e.showYears,
                    expression: "showYears"
                }], class: e.pre + "-prev-decade-btn", on: {
                    click: function (t) {
                        e.year -= 10
                    }
                }
                ...
                }], class: e.pre + "-prev-month-btn", on: {click: e.pm}
            }, [e._v("‹")]), s("a", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                ...
                directives: [{
                    ...
                    value: !e.showYears && !e.showMonths,
                    expression: "!showYears&&!showMonths"
                }], class: e.pre + "-next-month-btn", on: {click: e.nm}
            }, [e._v("›")]), s("a", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                ...
                directives: [{
                    ...
                    value: e.showYears,
                    expression: "showYears"
                }], class: e.pre + "-next-decade-btn", on: {
                    click: function (t) {
                        e.year += 10
                    }
                }
            }, [e._v("»")])], 2), s("div", {class: e.pre + "-body"}, [s("div", {class: e.pre + "-days"}, [e._l(e.local.weeks, function (t) {
                return s("a", {key: t, class: e.pre + "-week"}, [e._v(e._s(t))])
                ...
                return s("a", {
                    ...
                    on: {
                        click: function (t) {
                            e.is(t) && (e.showMonths = "M" === e.m, e.month = n, "M" === e.m && e.ok())
                        }
                    }
                }, [e._v(e._s(t))])
            })), s("div", {
                directives: [{name: "show", rawName: "v-show", value: e.showYears, expression: "showYears"}],
                class: e.pre + "-years"
                ...
                return s("a", {
                    ...
                    on: {
                        click: function (s) {
                            e.is(s) && (e.showYears = "Y" === e.m, e.year = t, "Y" === e.m && e.ok())
                        }
                    }
                }, [e._v(e._s(t))])
            })), s("div", {
                directives: [{name: "show", rawName: "v-show", value: e.showHours, expression: "showHours"}],
                class: e.pre + "-hours"
            }, [s("div", {class: e.pre + "-title"}, [e._v(e._s(e.local.hourTip))]), e._l(24, function (t, n) {
                return s("a", {
                    key: n,
            ...
            }, [s("div", {class: e.pre + "-title"}, [e._v(e._s(e.local.minuteTip))]), e._l(60, function (t, n) {
                return s("a", {
                    key: n,
            ...
            }, [s("div", {class: e.pre + "-title"}, [e._v(e._s(e.local.secondTip))]), e._l(60, function (t, n) {
                return s("a", {
                    key: n,
            ...
            })], 2)]), "H" === e.m ? s("div", {class: e.pre + "-foot"}, [s("div", {class: e.pre + "-hour"}, [s("a", {
                class: {on: e.showHours},
                attrs: {title: e.local.hourTip},
                on: {
                    click: function (t) {
                ...
                class: {on: e.showMinutes},
                attrs: {title: e.local.minuteTip},
                on: {
                    click: function (t) {
                ...
                class: {on: e.showSeconds},
                attrs: {title: e.local.secondTip},
                on: {
                    click: function (t) {
        ...
        }, u = [], l = o, h = n(i, c, u, !1, l, null, null), d = h.exports, p = {
            name: "VueDatepickerLocal",
            components: {VueDatepickerLocalCalendar: d},
            props: {
                name: [String],
                inputClass: [String],
                popupClass: [String],
            ...
            data: function () {
                return {show: !1, dates: this.vi(this.value)}
            },
            computed: {
                range: function () {
                    return 2 === this.dates.length
                }, text: function () {
                    var e = this, t = this.value, s = this.dates.map(function (t) {
                        return e.tf(t)
            ...
            methods: {
                get: function () {
                    ...
                    var s = e.getFullYear(), n = e.getMonth(), o = e.getDate(), a = e.getHours(),
                        r = a % 12 == 0 ? 12 : a % 12, i = e.getMinutes(), c = e.getSeconds(), u = e.getMilliseconds(),
                        l = function (e) {
                            return ("0" + e).slice(-2)
                        }, h = {
                            YYYY: s,
            ...
            return s("div", {
                ...
                class: {"datepicker-range": e.range, datepicker__clearable: e.clearable && e.text && !e.disabled}
            }, ["inline" !== e.type ? s("input", {
                class: [e.show ? "focus" : "", e.inputClass],
                attrs: {readonly: "", disabled: e.disabled, placeholder: e.placeholder, name: e.name},
                domProps: {value: e.text}
            }) : e._e(), s("a", {
                staticClass: "datepicker-close", on: {
                    click: function (t) {
                        return t.stopPropagation(), e.cls(t)
                    }
                }
            }), s("transition", {attrs: {name: "datepicker-anim"}}, [e.show || "inline" === e.type ? s("div", {
                staticClass: "datepicker-popup",
                class: [e.popupClass, {"datepicker-inline": "inline" === e.type}],
                attrs: {tabindex: "-1"}
            }, [e.range ? [s("vue-datepicker-local-calendar", {
                attrs: {left: !0},
                model: {
                    value: e.dates[0], callback: function (t) {
                        e.$set(e.dates, 0, t)
                    }, expression: "dates[0]"
                }
                ...
                attrs: {right: !0},
                model: {
                    value: e.dates[1], callback: function (t) {
                        e.$set(e.dates, 1, t)
                    }, expression: "dates[1]"
                }
            })] : [s("vue-datepicker-local-calendar", {
            ...
            })], e.showButtons ? s("div", {staticClass: "datepicker__buttons"}, [s("button", {
        ...
        }, m = [], w = a, v = n(p, f, m, !1, w, null, null), _ = v.exports;
        //_.install = r, "undefined" != typeof window && window.Vue && r(window.Vue);
        _.install = r, "undefined" != typeof window && Vue && r(Vue);
        t.default = _
    }, function (e, t) {
    }, function (e, t) {
    }])
