...
export default new Router({
  routes: [
    ...
    {
      path:'/InputNumber3',
      component:InputNumber3
    },
    {
      path:'/InputNumber4',
      component:InputNumber4
    },
    {
      path:'/InputNumber5',
      component:InputNumber5
    },
    {
      path:'/InputNumber6',
      component:InputNumber6
    },
    {
      path:'/Select1',
      component:Select1
    ...
    {
      path:'/MessageBox1',
      component:MessageBox1
    },
    {
      path:'/MessageBox2',
      component:MessageBox2
    },
    {
      path:'/MessageBox3',
      component:MessageBox3
    },
    {
      path:'/MessageBox4',
      component:MessageBox4
    },
    {
      path:'/MessageBox5',
      component:MessageBox5
    },
    {
      path:'/MessageBox6',
      component:MessageBox6
    },
    {
      path:'/MessageBox7',
      component:MessageBox7
    },
    {
      path:'/Notification1',
    ...
    {
      path:'/Notification5',
      component:Notification5
    },
    {
      path:'/Notification6',
      component:Notification6
    },
    {
      path:'/Notification7',
      component:Notification7
    },
    {
      path:'/NavMenu1',
      component:NavMenu1
